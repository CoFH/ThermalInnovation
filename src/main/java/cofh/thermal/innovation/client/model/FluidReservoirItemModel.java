...
public final class FluidReservoirItemModel implements IUnbakedGeometry<FluidReservoirItemModel> {
    ...
    private static final Transformation FLUID_TRANSFORM = new Transformation(MathHelper.ZERO, new Quaternionf(), new Vector3f(1, 1, 1.004f), new Quaternionf());
    private static final Transformation COVER_TRANSFORM = new Transformation(MathHelper.ZERO, new Quaternionf(), new Vector3f(1, 1, 1.008f), new Quaternionf());
